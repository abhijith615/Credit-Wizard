        ...
        <div ref={gridRef} className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {loans.map((loan, i) => (
            <Link
              ...
              className={`card-luxe group relative overflow-hidden rounded-3xl p-9 ${
            ...
            >
              ...
              <span className="relative flex h-16 w-16 items-center justify-center rounded-2xl bg-navy-50 text-navy-700 transition-colors duration-500 group-hover:bg-navy-700 group-hover:text-gold-300">
                <LoanIcon name={loan.icon} />
              </span>

              <h3 className="font-serif-display relative mt-7 text-2xl text-navy-800">
                {loan.name}
              </h3>
              ...
              <span className="relative mt-8 inline-flex items-center gap-2 text-sm font-semibold text-navy-700 transition-colors duration-300 group-hover:text-gold-600">
                Learn More
                <svg
          ...
          >
            ...
            <Link
              ...
              className="mt-8 inline-flex w-fit items-center gap-2.5 rounded-full bg-gold-500 px-7 py-3.5 text-sm font-semibold text-navy-900 transition-colors duration-300 hover:bg-gold-400"
            >
